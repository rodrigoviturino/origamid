...
//  OBS: setTimeout é um método ASSINCRONO com isso, ele vai executar por fundo e quando estiver pronto, mostra na tela.
...
// ao usar function() o valor do THIS MUDA ele pega o pai que é o WINDOW, sendo usado com setTimeout, se for pegar o pai daquele contexto é preciso usar ARROW FUNCTION
const btn = document.querySelector("button");
btn.addEventListener("click", handleClick);
